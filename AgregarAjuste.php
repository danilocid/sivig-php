              ...
              <?php
               ...
               if (isset($_SESSION['articulo'])) {
                ...
                echo '<tr>
                    ...
                    echo '<td>
                    <form action="ActualizarArticuloAjuste" method="POST">
                    <input class="form-control input-sm" readonly type="number" name="costo_neto" required value="'.($articuloventa[0]['costo_neto'] * $a->cantidad) .'">
                    </td>';
                    echo '<td>
                  ...
                  <div class="modal-body">
                    <form role="form" action="AgregarAjustes" method="POST">        
                        ...
                        <div class ="form-group">
                          ...
                          <input id="observaciones" name="observaciones" required type="text" class="form-control input-sm">
                        </div>
                        <div class ="form-group">
                          <label>Tipo de movimiento</label>
                          <select id="tipo_movimiento" name="tipo_movimiento" class="form-control select2">
                          <?php
                        ...
                        <div class ="form-group">
                          ...
                          <input id="monto_neto" name="monto_neto" disabled type="text" class="form-control input-sm" value="$<?php echo number_format($monto_total, 0, ',', '.'); ?>">
                          <input id="monto_neto" name="monto_neto" type="hidden" class="form-control input-sm" value="<?php echo $monto_total; ?>">
                        </div>
                        <div class ="form-group">
                          <label>Impuestos</label>
                          <input id="monto_imp" name="monto_imp" disabled type="text" class="form-control input-sm" value="$<?php echo number_format($monto_imp, 0, ',', '.'); ?>">
                          <input id="monto_imp" name="monto_imp" type="hidden" class="form-control input-sm" value="<?php echo $monto_imp ; ?>">
                        </div>
                        <div class ="form-group">
                          <label>Monto total</label>
                          <input id="monto_total" name="monto_total" disabled type="text" class="form-control input-sm" value="$<?php echo number_format($monto_total + $monto_imp, 0, ',', '.'); ?>">
                          <input id="monto_total" name="monto_total" type="hidden" class="form-control input-sm" value="<?php echo ($monto_total * 1.19); ?>">
                        </div>
