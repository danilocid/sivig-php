    ...
    <section class="content">
      ...
      <a href="Articulos?o=1" class="btn  btn-md btn-info">mostrar articulos sin stock</a>
                ...
                <div class="float-left">
                    <a href="pdf/ArticulosPDF" target="_blank" class="btn  btn-lg btn-info pull-left">Ver PDF</a>
                </div>
                    ...
                    <div class="modal-body">
                        <form role="form" action="AgregarArticulo" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input id="c_venta_neto" oninput="ActualizaValorTotal()" name="c_venta_neto" required
                                    type="number" class="form-control input-sm">
                                <input id="stock" name="stock" hidden type="number" value="0"
                                    class="form-control hidden input-sm">
                                <input id="c_costo_neto" name="c_costo_neto" hidden type="number" value="0"
                                    class="form-control hidden input-sm">
                                <input id="c_costo_imp" name="c_costo_imp" hidden type="number" value="0"
                                    class="form-control hidden input-sm">
                                <input id="enlace" name="enlace" hidden type="text" value="Articulos"
                                    class="form-control hidden input-sm">
                            </div>
                            <div class="form-group">
                                <label>I.V.A.</label>
                                <input id="c_venta_imp" name="c_venta_imp" required readonly type="text"
                                    class="form-control input-sm">
                            </div>
                            <div class="form-group">
                                <label>Precio de venta total</label>
                                <input id="c_venta_total" oninput="ActualizaValorNeto()" name="c_venta_total" required
                                    type="number" class="form-control input-sm">
                            </div>
                            <div class="form-group">
                                <label>Activo</label>
