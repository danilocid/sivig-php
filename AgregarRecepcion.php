...
$(document).ready(function() {
    $("#region").change(function() {
        ...
        $('#comuna').find('option').remove().end().append('<option value="whatever"></option>').val(
            'whatever');
                            ...
                            <form action="AgregarArticuloRecepcion" method="POST">
                                ...
                                ';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" oninput="ActualizaValorCostoUnitario()"
                                            class="form-control" id="costo_neto" name="costo_neto" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="costo_imp">I.V.A. (unitario)</label>
                                        <input type="number" class="form-control" id="costo_imp" name="costo_imp"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="costo_total">Total (unitario)</label>
                                        <input type="number" oninput="ActualizaValorCostoNetoUnitario()"
                                            class="form-control" id="costo_total" name="costo_total" required>
                                    </div>
                                </div>
                    ...
                    Finalizar recepcion
                              ...
                              ';
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="observaciones" required name="observaciones"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="monto_neto" name="monto_neto" type="hidden"
                                                            class="form-control input-sm"
                                                            value="<?php echo $monto_neto; ?>">
                                                        <input id="monto_imp" name="monto_imp" type="hidden"
                                                            class="form-control input-sm"
                                                            value="<?php echo $monto_imp; ?>">
                                                    </div>
                                        ...
                                        <div class="modal-body">
                                            <form role="form" action="AgregarArticulo" method="POST">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cod_interno" name="cod_interno" required type="text"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Codigo de barras</label>
                                                    <input required type="text" id="cod_barras" name="cod_barras"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Descripcion</label>
                                                    <input id="descripcion" name="descripcion" required type="text"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Costo neto</label>
                                                    <input id="c_costo_neto" name="c_costo_neto"
                                                        oninput="ActualizaValorCostoTotal()" required type="number"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Costo impuestos</label>
                                                    <input id="c_costo_imp" name="c_costo_imp" readonly type="number"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Costo total</label>
                                                    <input id="c_costo_total" name="c_costo_total"
                                                        oninput="ActualizaValorCostoNeto()" required type="number"
                                                        class="form-control form-control-sm">
                                                </div>

                                                <div class="form-group">
                                                    <label>Precio de venta neto</label>
                                                    <input id="c_venta_neto" name="c_venta_neto"
                                                        oninput="ActualizaValorVentaTotal()" required type="number"
                                                        class="form-control input-sm">
                                                    <input id="stock" name="stock" hidden required type="number"
                                                        value="0" class="form-control hidden input-sm">
                                                    <input id="pagina" name="pagina" hidden required type="text"
                                                        value="AgregarRecepcion" class="form-control hidden input-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Precio de venta impuestos</label>
                                                    <input id="c_venta_imp" name="c_venta_imp" readonly type="number"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Precio de venta total</label>
                                                    <input id="c_venta_total" name="c_venta_total"
                                                        oninput="ActualizaValorVentaNeto()" required type="number"
                                                        class="form-control form-control-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Activo</label>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" action="AgregarProveedor" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <label>RUT</label>
                                                    <input id="rut" name="rut" required type="text"
                                                        oninput="checkRut(this)" class="form-control input-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Giro</label>
                                                    <input id="giro" name="giro" required type="text"
                                                        class="form-control input-sm">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="telefono" name="telefono" required type="number"
                                                        min="111111111" max="999999999" class="form-control input-sm">
                                                </div>
                                                <div class="form-group">
                                                    <label>Mail</label>
