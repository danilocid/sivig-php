				...
				<tr class="information">
					<td colspan="3">
						<table >
							<tr>
								<td >
								<?php echo $tipos->GetTiposDocumentosPorId($venta[0]['tipo_documento']) . ' :'. $venta[0]['documento']; ?><br />
								Fecha de venta: <?php echo $newDate;?><br />
								Medio de pago: <?php echo $mediodepago;?>
								</td>
								<td></td>
								<td>
								<?php echo $cliente[0][0];?><br />
								<?php echo $cliente[0][1];?>
			...
			<table cellpadding="0" cellspacing="0" >
				...
				foreach ($detalleventa as $d) {
					echo '<tr class="datos">
						...
						<td class="datos">' . "$" . number_format(($d['precio_neto'] + $d['precio_imp']) * $d['cantidad'], 0, ',', '.') . '</td>
					</tr>';
				} ?>
				...
				<tr class="total">
					...
					<td></td>
					<td></td>
					<td>Total NETO: <?php echo '$' . number_format($venta[0]['monto_neto'], 0, ',', '.');?></td>
				</tr>
				<tr class="total">
				
					<td></td>
					<td></td>
					<td>I.V.A.: <?php echo '$' . number_format($venta[0]['monto_imp'], 0, ',', '.');?></td>
				</tr>
				<tr class="total">
				
					<td></td>
					<td></td>
					<td>Total: <?php echo '$' . number_format($venta[0]['monto_imp'] + $venta[0]['monto_neto'], 0, ',', '.');?></td>
				</tr>
